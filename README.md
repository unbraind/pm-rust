...
published `pm` 2026.9.7 on-disk contract. Production code, tests, benchmarks,
...
cargo audit
npm exec --yes --package=@unbrained/pm-cli@2026.9.7 -- pm health --check-only --require-merge-drivers --strict-exit
```
