...
published `pm` 2026.8.31 on-disk contract. Production code, tests, benchmarks,
...
cargo audit
npm exec --yes --package=@unbrained/pm-cli@2026.8.31 -- pm health --check-only --require-merge-drivers --strict-exit
```
